...
On launch, invoicemanagement will refuse to start if it is not able to connect to any of the above component(s).
...
Build the docker image: `docker build -t invoicemanagement:latest .`

Start the container: `docker run -d -p 9020:9020 invoicemanagement:latest`
