...
default() {
    ...
    kubectl delete -f ui-${suffix}/
    kubectl delete -f customermanagement-${suffix}/
    kubectl delete -f invoicemanagement-${suffix}/
    kubectl delete -f paymentmanagement-${suffix}/
