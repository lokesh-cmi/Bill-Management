    ...
    <div className="App">
      ...
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/swagger/invoicemanagement"
            element={
              <PrivateRoute>
                <div className="swagger">
                  <SwaggerUI url={process.env.REACT_APP_MICROSERVICE_INVOICEMANAGEMENT.concat('/v3/api-docs')} />
                </div>
              </PrivateRoute>
            }
          />
          ...
          />
          <Route
            path="/notes/invoicemanagement"
            element={
              <PrivateRoute>
                <div className="component">
                  <NotesList notesApp={'invoicemanagement'} />
                </div>
              </PrivateRoute>
            }
          />
