        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className={isSubMenuOpen ? 'sub-menu-wrap open-menu' : 'sub-menu-wrap'} id="subMenu">
              <div class="sub-menu">
                <a href="/swagger/customermanagement" class="sub-menu-link">
                  <img src=""></img>
                ...
                <hr></hr>
                <span></span>
                <a href="/swagger/invoicemanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>invoicemanagement</h5>
                  <span>&gt;</span>
                </a>
                <hr></hr>
                <span></span>
                <a href="/swagger/paymentmanagement" class="sub-menu-link">
                  <img src=""></img>
            ...
            <div className={isSubMenuOpenForNotes ? 'sub-menu-wrap open-menu' : 'sub-menu-wrap'} id="subMenu">
              <div class="sub-menu">
                <a href="/notes/customermanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>customermanagement</h5>
                  <span>&gt;</span>
                </a>
                <hr></hr>
                <span></span>
                <a href="/notes/invoicemanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>invoicemanagement</h5>
                  <span>&gt;</span>
                </a>
                <hr></hr>
                <span></span>
                <a href="/notes/paymentmanagement" class="sub-menu-link">
                  <img src=""></img>
                  <h5>paymentmanagement</h5>
                  <span>&gt;</span>
                </a>
